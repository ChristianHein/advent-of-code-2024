...
public sealed class AdventOfCode2024
{
    ...
    public static void PrintDay13Solution()
    {
        var puzzle = new Day13.Puzzle(File.ReadAllLines("Day13/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay14Solution()
    {
        var puzzle = new Day14.Puzzle(width: 101, height: 103, File.ReadAllLines("Day14/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay15Solution()
    {
        var puzzle = new Day15.Puzzle(File.ReadAllLines("Day15/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay16Solution()
    {
        var puzzle = new Day16.Puzzle(File.ReadAllLines("Puzzle/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay17Solution()
    {
        var puzzle = new Day17.Puzzle(File.ReadAllLines("Day17/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay18Solution()
    {
        var puzzle = new Day18.Puzzle(width: 71, height: 71, part1CorruptedBytes: 1024, File.ReadAllLines("Day18/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay19Solution()
    {
        var puzzle = new Day19.Puzzle(File.ReadAllLines("Day19/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay22Solution()
    {
        var puzzle = new Day22.Puzzle(File.ReadAllLines("Day22/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }

    public static void PrintDay23Solution()
    {
        var puzzle = new Day23.Puzzle(File.ReadAllLines("Day23/input"));
        Console.WriteLine(FormatDaySolutions(puzzle));
    }
